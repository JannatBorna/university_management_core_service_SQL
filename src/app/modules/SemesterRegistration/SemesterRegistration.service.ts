...
//enrollIntoCourse table StudentSemesterRegistrationCourse (full StudentSemesterRegistrationCourseService kaj kora hoyese)
...
//withdraw table StudentSemesterRegistrationCourse withdraw korle 1 kore kombe (full StudentSemesterRegistrationCourseService kaj kora hoyese)
...
const confirmMyRegistration = async (
  ...
  //  totalCreditsTaken 0 thake error dibe
  ...
  //minCredit: 3, maxCredit: 6,  ache ki, na thake error dibe, bashi hole error dibe
  //totalCreditsTaken(tct) = 3
  // minC = 3
  // maxC = 6
  // tct < minC || tct > maxC ay condition hole error dibe
  ...
  return {
    message: 'your registration is confirm!!',
  };
};
...
const getMySemesterRegCouses = async (authUserId: string) => {
  ...
  //student কোন কোন complete করেছে
