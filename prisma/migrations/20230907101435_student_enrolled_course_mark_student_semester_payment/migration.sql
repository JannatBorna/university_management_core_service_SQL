...
-- AddForeignKey
ALTER TABLE "student_enrolled_course_marks" ADD CONSTRAINT "student_enrolled_course_marks_studentEnrollCourseId_fkey" FOREIGN KEY ("studentEnrollCourseId") REFERENCES "student_enroll_course"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
